          ...
          if(register_student_course_state(course_name,num_student) is False):
               ...
               for course in datas['courses']:
                    if course_name==course['name']:
                         ...
                         for student in course['students']:
                              if student['num']==num_student:
                                   print(num_2point(student['grade']))
          ...
          if grade_exist:
               ...
               if state!="update":
                    if count_unit==0:
                         ...
                         print(num_2point(grade_sum/count_unit))      
               ...
               for student in course['students']:
                    if num_student == student['num']:
                         ...
                         if course['grade_state']:
                                course_avg_grades =num_2point( course['grade_avg'])
                                student_grade =num_2point( student['grade'])
